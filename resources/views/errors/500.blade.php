...
.buttons-con .action-link-wrap2 a {
  background: #37b456;
  padding: 8px 25px;
  border-radius: 4px;
  color: #FFF;
...
<div class="message-box">
  <h1 class="upper">500</h1>
  <p class="upper">Something Went Wrong</p>
  <div class="buttons-con" style="margin-top: 10%">
    <div class="action-link-wrap" style="display: inline">
